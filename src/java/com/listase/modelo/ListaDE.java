...
//    }
    ...
    public void adelantarInfante(Infante nuevo, short posicion) throws InfanteExcepcion {
        if (cabeza != null) {
            ...
            if (posicion <= 0) {
                throw new InfanteExcepcion("la posisicion" + posicion + "no existe");
                ...
                throw new InfanteExcepcion("la posisicion no existe");
            }
        }
    ...
    public short obtenerPosicion(short codigo) throws InfanteExcepcion {
        if (cabeza == null) {
            throw new InfanteExcepcion("La lista de piloto está vacía");
        } else {
            NodoDE temp = cabeza;
            short cont = 1;
            while (temp != null) {
